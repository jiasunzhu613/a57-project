...
```{r}
ggplot(NO2, aes(x = Year, y = Mean, col = City)) + geom_point() + theme(legend.position="none") 
...
ggplot(TRS, aes(x = Year, y = Mean, col = City)) + geom_point() + theme(legend.position="none") 
